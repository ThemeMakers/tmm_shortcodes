...
/*
  ...
  Description: Universal Shortcodes Package (CarDealer)
  Author: ThemeMakers
  Version: 1.0.5
...
class TMM_Ext_Shortcodes {
	...
	public static function register() {
		...
		add_filter('attachment_fields_to_edit', array(__CLASS__, 'attachment_fields'));
	...
	public static function attachment_fields($form_fields) {
		global $post;
