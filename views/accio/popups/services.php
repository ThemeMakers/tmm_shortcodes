...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="fullwidth">
		...
		<?php
		$type_array = array(
			'icon-paper-plane-2' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-paper-plane-2',
			'icon-pencil-7' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-pencil-7',
			'icon-cog-6' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-cog-6',
			'icon-beaker-1' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-beaker-1',
			'icon-megaphone-3' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-megaphone-3',
			'icon-search' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-search',
			'icon-comment-6' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-comment-6',
                        'icon-lightbulb-3' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-lightbulb-3',
                        'icon-thumbs-up-5' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-thumbs-up-5',
			'icon-laptop' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-laptop',
			'icon-wrench' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-wrench',
			'icon-leaf' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-leaf',
			'icon-cogs' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-cogs',
			'icon-group' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-group',
			'icon-comments-alt' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-comments-alt',
			'icon-folder-close' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-folder-close',
			'icon-cloud' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-cloud',
			'icon-briefcase' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-briefcase',
			'icon-beaker' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-beaker',
			'icon-bullhorn' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-bullhorn',
			'icon-comment' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-comment',
			'icon-globe' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-globe',
			'icon-globe-6' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-globe-6',
			'icon-heart' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-heart',
			'icon-rocket' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-rocket',
			'icon-suitcase' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-suitcase',
			'icon-pencil' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-pencil',
			'icon-params' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-params',
			'icon-folder-open' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-folder-open',
			'icon-cog' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-cog',
			'icon-coffee' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-coffee',
			'icon-gift' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-gift',
			'icon-home' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-home',
			'icon-lightbulb' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-lightbulb',
			'icon-thumbs-up' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-thumbs-up',
			'icon-umbrella' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-umbrella',
			'icon-random' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-random',
			'icon-th-list' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-th-list',
			'icon-resize-small' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-resize-small',
			'icon-download-alt' => esc_html__('Icon', 'tmm_shortcodes') . ': ' . 'icon-download-alt'
