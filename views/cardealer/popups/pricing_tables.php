...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<ul id="price_tables_list">
		...
		<?php
		$shortcodes_texts_array = array(0 => '[price_table title="' . __('Starter Package', 'tmm_shortcodes') . '" price="' . __('19.95', 'tmm_shortcodes') . '" button_text="' . __('Details', 'tmm_shortcodes') . '" button_link="#" featured="0"]^^^[/price_table]');
		//***
				...
				<section class="simple-pricing-table col1 clearfix">
					...
					<div class="column">
						...
						<div class="footer">
							...
							<label class="label">
								<span></span>
								<i class="description"><?php _e('Is Featured', 'tmm_shortcodes'); ?></i>
							</label>
						</div><!-- .footer -->
