...
$map_link = 'https://maps.google.com/maps/api/js?' . $google_maps_api_key;
	...
	wp_enqueue_script('tmm_google_maps_api', 'https://maps.google.com/maps/api/js?' . $google_maps_api_key);
...
<?php else: ?>
	...
	<img src="https://maps.google.com/maps/api/staticmap?<?php echo $location_mode_string ?>&zoom=<?php echo (int) $zoom ?>&maptype=<?php echo strtolower($maptype) ?>&size=<?php echo (int)$width ?>x<?php echo (int)$height ?><?php echo $marker_string ?>&key=<?php echo TMM::get_option("api_key_google")?>">
