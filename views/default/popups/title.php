...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="one-half">
		...
		TMM_Ext_Shortcodes::draw_shortcode_option(array(
			...
			'default_value' => TMM_Ext_Shortcodes::set_default_value('font_weight', ''),
			'description' => ''
		));
		?>
	</div><!--/ .ona-half-->
	...
	<div class="one-half">
		...
		TMM_Ext_Shortcodes::draw_shortcode_option(array(
			...
			'options' => array(
				...
				'center' => __('Center', 'tmm_shortcodes'),
			),
		...
		TMM_Ext_Shortcodes::draw_shortcode_option(array(
			'type' => 'checkbox',
			'title' => __('Show border under the title', 'tmm_shortcodes'),
			'shortcode_field' => 'section_title',
			'id' => 'section_title',
			'is_checked' => TMM_Ext_Shortcodes::set_default_value('section_title', 0),
			'description' => ''
		));
		?>
