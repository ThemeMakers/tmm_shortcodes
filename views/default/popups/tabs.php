...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="fullwidth">
		...
		<a class="button button-small js_add_accordion_item" href="#"><?php _e('Add item', 'tmm_shortcodes'); ?></a><br />
					...
					<table style="width: 100%;">
						<tr>
							<td valign="top" style="width: 100%;">
								<input placeholder="<?php _e('Title', 'tmm_shortcodes'); ?>" type="text" value="<?php echo $titles_edit_data[$key] ?>" class="accordion_item_title js_shortcode_template_changer" style="width: 67%;" />
								&nbsp;<a class="button button-small js_delete_accordion_item js_shortcode_template_changer" href="#"><?php _e('Remove', 'tmm_shortcodes'); ?></a>
							</td>
						</tr>
						<tr>
							<td valign="top" style="width: 100%;" colspan="2">
								<textarea placeholder="<?php _e('Content', 'tmm_shortcodes'); ?>" class="accordion_item_content js_shortcode_template_changer data-area" placeholder="<?php _e('Content', 'tmm_shortcodes'); ?>"><?php echo $content_edit_text ?></textarea>
							</td>
						</tr>
					</table>
				</li>
