    ...
    $(function() {
        ...
        tinymce.create("tinymce.plugins.tmm_tiny_shortcodes", {
            ...
            open_shortcode_popup: function(params) {
                ...
                show_static_info_popup(tmm_lang_loading);
                ...
                $.post(ajaxurl, data, function(html) {
                    ...
                    var popup_params = {
                        ...
                        open: function() {
                            var selects = $('.tmm-popup-single-shortcode').find('select');
                            if (selects.length) {
                                selects.each(function(i, val) {
                                    $(val).wrap('<div class="sel"></div>');
                                });
                            }
                        },
                        close: function() {
                        ...
                        save: function() {
                            ...
                            if (mode == 'edit') {                                                                       
                                ...
                                show_info_popup(tmm_ext_shortcodes_lang1 + '!');
                            } else {
                                if (window.tinyMCE) {
            ...
            edit_shortcode: function(tag, sc_id) {                    
                ...
                self.open_shortcode_popup({name: tag, title: tmm_ext_shortcodes_lang3 + ': ' + name, mode: 'edit', text: shortcode_text, sc_id: sc_id});
